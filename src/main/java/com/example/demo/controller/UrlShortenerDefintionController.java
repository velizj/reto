...
public interface UrlShortenerDefintionController {
  ...
  ResponseEntity<ShortUrlResponse> shortenUrl(@RequestBody @Valid LongUrlRequest longUrlRequest);
    ...
    @ApiResponses(
     ...
     ResponseEntity<LongUrlResponse> expandUrl(@RequestBody ShortUrlRequest shortUrlRequest) throws MalformedURLException;
    ...
    @ApiResponses(
     ...
     ResponseEntity<Void> deleteMultipleUrls(@RequestBody DeleteShortUrlsRequest deleteShortUrlsRequest);
}
